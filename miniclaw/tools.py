...
class ToolRunner:
    def __init__(self, config_store: ConfigStore, event_log: EventLog, mcp: MCPServerManager) -> None:
    ...
    def _fetch_url(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        timeout = int(arguments.get("timeout_seconds") or 20)
    ...
    def run(self, tool_name: str, arguments: Optional[Dict[str, Any]], trace: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        self._event_log.add(
            ...
            {"tool": name, "arguments": args, "trace": trace_details},
        )
        try:
            if name == "run_command":
            ...
            self._event_log.add(
                ...
                {"tool": name, "duration_seconds": payload["duration_seconds"]},
            )
            return payload
