...
metadata = {
    ...
    "description": (
        "Analyzes user requests and determines which files (skills, memory, jobs) should be used "
        "based on a chain of thought approach, leveraging the skill registry's matching capabilities."
    ),
}
