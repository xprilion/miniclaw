...
metadata = {
    ...
    "description": "Formats responses appropriately for different channels (Telegram, WhatsApp, Web, etc.). Removes markdown for chat channels and preserves it for web channels.",
}
